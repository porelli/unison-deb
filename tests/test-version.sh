...
# Test the deb-version.sh wrapper with real packaging/revision (value 1)
assert_eq "$(sh scripts/deb-version.sh 2.54.0 trixie)"   "2.54.0-1+porelli1~deb13"  "deb-version.sh trixie"
